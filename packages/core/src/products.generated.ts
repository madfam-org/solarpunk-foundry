...
export const generatedProducts = {
  ...
  forgesight: {
    ...
    isPublic: false,
    domain: "forgesight.app",
    hosts: [
      "www.forgesight.app",
      "app.forgesight.app",
      "api.forgesight.app",
      "admin.forgesight.app",
    ],
    infraHosts: [],
    site: {
